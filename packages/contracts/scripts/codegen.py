...
TARGETS = [
    ...
    (AudioProviderContracts, "audio-provider", "audio_provider", "AudioProviderContracts"),
    (AudioProviderHealth, "audio-provider-health", "audio_provider", "AudioProviderHealth"),
    (VoicePresetLibrary, "voice-preset", "voice_preset", "VoicePresetLibrary"),
...
OWNER_FILE = {
    ...
    "AudioConfig": "audio-provider",
    "AudioProviderContracts": "audio-provider",
    "PiperTTSConfig": "audio-provider",
    "TTSProviderConfig": "audio-provider",
    "GptSoVitsProviderConfig": "audio-provider",
    "GptSoVitsLaunchConfig": "audio-provider",
    "GptSoVitsActivationGate": "audio-provider",
    "GptSoVitsHealthRequest": "audio-provider",
    "GptSoVitsTestSynthesisRequest": "audio-provider",
    "GptSoVitsTestSynthesisResult": "audio-provider",
    "STTProviderConfig": "audio-provider",
    "AudioProviderHealth": "audio-provider-health",
    "FailedAudioMetadata": "audio-payload",
    "VoicePresetLibrary": "voice-preset",
    "VoicePreset": "voice-preset",
    "GptSoVitsPresetConfig": "voice-preset",
    "ReferenceAudioAsset": "voice-preset",
    "ActivePresetAssociation": "voice-preset",
