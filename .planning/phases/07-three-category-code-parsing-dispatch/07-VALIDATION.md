...
| 07-05-01 | 05 | 2 | PARSE-05, PARSE-06 | unit | `cd sidecar && uv run pytest tests/vts/test_variant_state_manager.py tests/vts/test_event_completion_tracker.py -x --no-header` | Task creates tests, including final-delay `EventFire.duration_ms=2833 -> 2.833s` and fallback `missing/zero/oversized -> 10.0s` assertions | pending |
