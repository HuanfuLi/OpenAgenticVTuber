...
verified: 2026-05-09T06:41:03-04:00
requirements:
  - STAT-01
  - STAT-02
  - STAT-03
...
PASSED. The status bar, app store, setup-derived status, and preference persistence paths now use real runtime sources or truthful unavailable states instead of production-path mocks.

## Must-Haves

| Requirement | Verdict | Evidence |
|-------------|---------|----------|
| STAT-01 | Pass | `StatusIcon.test.tsx` verifies stored LM Studio provider/model appears as `teto-test-model · LM Studio`, with no hardcoded Qwen or fake latency text. |
...
| `npm --workspace apps/renderer run test` | Pass, 53 tests |
