...
- [ ] **Phase 17: GPT-SoVITS Provider + Voice Presets** - GPT-SoVITS external/app-launched provider, test synthesis, reference audio, and named presets. In progress: 5/7 plans complete.
...
| 17. GPT-SoVITS Provider + Voice Presets | v3.0 | 5/7 | In Progress | - |
