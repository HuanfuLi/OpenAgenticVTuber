...
- [x] **Phase 17: GPT-SoVITS Provider + Voice Presets** - GPT-SoVITS external/app-launched provider, test synthesis, reference audio, named presets, and visible failed-audio chat/UAT evidence. Complete after plan 17-09 duplicate-dispatch gap closure; live Test 6 retest remains pending user confirmation.
...
| 17. GPT-SoVITS Provider + Voice Presets | v3.0 | 9/9 | Complete | 2026-05-10 |
