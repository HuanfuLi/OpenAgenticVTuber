# Roadmap Archive: AgenticLLMVTuber v2.0 Plugin + Animation Control
...
This is the v2.0 roadmap snapshot at archive time. It preserves the plugin-runtime, avatar-catalog, parser-dispatch, HUD, and §14 re-verification phase details.
