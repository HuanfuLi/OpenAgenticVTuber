...
export const COPY = {
  ...
  SETTINGS: {
    ...
    VOICE_IN_VAD_HELP: 'Experimental opt-in. Keep headphones on; no-headphones echo handling is deferred to Phase 22.',
    ...
    VOICE_IN_VAD_SAFETY: 'Conservative by default. VAD pauses while Teto is speaking and does not replace PTT.',
    ...
    VOICE_IN_MODEL_CACHE: 'Local model cache',
