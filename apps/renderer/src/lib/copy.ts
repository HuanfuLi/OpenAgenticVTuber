...
export const COPY = {
  ...
  SETTINGS: {
    ...
    VOICE_PRESET_NEEDS_TEST: 'Needs test synthesis',
    VOICE_PRESET_CHANGED_SINCE_TEST: 'Changed since last test',
    ...
    VOICE_IN_VAD_SAFETY: 'Conservative by default. VAD pauses while Teto is speaking; no-headphones echo handling is deferred to Phase 22.',
    ...
    VOICE_IN_TEST_NOT_READY: 'STT test did not run. Provider adapter lands in Phase 19.',
