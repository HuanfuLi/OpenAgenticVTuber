...
export const COPY = {
  ...
  SETTINGS: {
    ...
    AVATARS_DEGRADED: 'Catalog metadata is unavailable for this avatar. Start or restart the sidecar, then try Edit current again.',
    AVATARS_DEGRADED_UNKNOWN: 'Current avatar ID and catalog metadata are unavailable. Start or restart the sidecar, then use Import/replace if needed.',
