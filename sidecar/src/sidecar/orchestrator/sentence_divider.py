"""Ported verbatim from Open-LLM-VTuber utils/sentence_divider.py (MIT) -- see PROVENANCE.md.

The only adaptations vs OLVT:
  - Provenance header (this docstring).
  - No OLVT-internal imports were used by SentenceDivider, so no import edits.
"""
import re
